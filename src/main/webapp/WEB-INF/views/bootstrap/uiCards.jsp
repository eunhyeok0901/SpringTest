						...
						<div class="card">
							...
							<div class="card-body">
								...
								<p class="card-text">This is a wider card with supporting
									text and below as a natural lead-in to the additional content.
					...
					<div class="col-md-6 col-lg-3">
						<div class="card">
							...
							<div class="card-footer">
								...
								<a href="#" class="card-link float-right"><small>Card
										link</small></a>
							</div>
						</div>
					</div>
		...
		<div class="row">
			<div class="col-12">
				...
				<p>
					...
					<code class="highlighter-rouge">.card-body</code>
					...
					<div class="col-md-6 col-lg-3">
						<div class="card">
							...
							<div class="card-footer">
								...
								<a href="#" class="card-link m-l-30"><small>Card
										link</small> </a><a href="#" class="btn btn-primary float-right">Go
									somewhere</a>
							</div>
						</div>
					</div>
				...
				<div class="row m-b-30">
					<div class="col-lg-6">
						<div class="card border-primary">
							...
							<div class="card-footer">
								<small>Last updateed 3 min ago</small>
							</div>
						</div>
					</div>
					<div class="col-lg-6">
