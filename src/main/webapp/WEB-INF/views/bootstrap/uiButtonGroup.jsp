			...
			<div class="col-lg-12">
				<div class="card">
					<div class="card-body">
						...
						<p class="text-muted">Combine sets of button groups into
							button toolbars for more complex components</p>
						<div class="button-group">
							...
							<div class="btn-group">
								...
								<div class="btn-group">
									<button id="btnGroupDrop1" type="button"
										class="btn btn-primary dropdown-toggle" data-toggle="dropdown">Dropdown</button>
							...
							<div aria-label="Vertical button group" role="group"
								...
								<div role="group" class="btn-group">
									<button data-toggle="dropdown"
										class="btn btn-primary dropdown-toggle" type="button">Dropdown</button>
									<div class="dropdown-menu">
										<a href="#" class="dropdown-item">Dropdown link</a> <a
											href="#" class="dropdown-item">Dropdown link</a>
									</div>
								</div>
								<button class="btn btn-primary" type="button">Button</button>
								<button class="btn btn-primary" type="button">Button</button>
