	...
	<div class="container-fluid">
					...
					<div class="card-body">
						...
						<div class="bootstrap-popover">
							<span class="d-inline-block" data-toggle="popover"
								data-content="Disabled popover"><button
									class="btn btn-secondary" style="pointer-events: none;"
									type="button" disabled="disabled">Disabled button</button></span>
						</div>
					</div>
				</div>
			</div>
						...
						<div class="bootstrap-popover">
							<button type="button" class="btn btn-primary"
								...
								data-content="Vivamus
                                                  ...
                                                  sagittis lacus vel augue laoreet rutrum faucibus.">Popover
								on bottom</button>
						</div>
					</div>
				</div>
				...
				<div class="card">
					<div class="card-body">
						...
						<button type="button" class="btn btn-secondary"
							data-toggle="tooltip" data-placement="top" title="Tooltip on top">Tooltip
							on top</button>
					</div>
				</div>
			</div>
		...
		<div class="row">
			...
			<div class="col-lg-12">
				<div class="card">
					<div class="card-body">
						<h4 class="card-title">Disable Tooltip</h4>
						<span class="d-inline-block" tabindex="0" data-toggle="tooltip"
							title="Disabled tooltip"><button class="btn btn-secondary"
								style="pointer-events: none;" type="button" disabled="disabled">Disabled
								button</button></span>
					</div>
				</div>
			</div>
