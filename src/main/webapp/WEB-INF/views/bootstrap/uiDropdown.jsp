			...
			<div class="col-lg-12">
				<div class="card">
					<div class="card-body">
						...
						<p class="text-muted">A dropdown menu is a toggleable menu
							that allows the user to choose one value from a predefined list</p>
						...
						<div class="basic-dropdown">
							<div class="dropdown">
								<button type="button" class="btn btn-primary dropdown-toggle"
									data-toggle="dropdown">Dropdown button</button>
								<div class="dropdown-menu">
									<a class="dropdown-item" href="#">Normal</a> <a
										class="dropdown-item active" href="#">Active</a> <a
										class="dropdown-item disabled" href="#">Disabled</a>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="card">
					<div class="card-body">
						...
						<div class="basic-dropdown">
							...
							<!-- Split dropup button -->
							<div class="btn-group dropup mb-2">
								<button type="button" class="btn btn-primary">Split
									dropup</button>
								<button type="button"
			...
			<div class="col-lg-12">
				<div class="card">
					<div class="card-body">
						...
						<p class="text-muted">Button dropdowns work with buttons of
						...
						<div class="dropdown-size">
							...
							<div class="btn-group mb-1">
								<button class="btn btn-primary btn-lg" type="button">Large
									split button</button>
								<button type="button"
						...
						<div class="row">
							...
							<div class="col">
								<div class="dropdown custom-dropdown">
									<button type="button" class="btn btn-sm btn-outline-primary"
										data-toggle="dropdown">
										Last 1 Hour <i class="fa fa-angle-down m-l-5"></i>
									</button>
									<div class="dropdown-menu dropdown-menu-right">
										<a class="dropdown-item" href="#">Last 1 hour</a> <a
											class="dropdown-item" href="#">Last 2 hour</a> <a
											class="dropdown-item" href="#">Last 3 hour</a>
									</div>
								</div>
							</div>
							<div class="col">
							...
							<div class="col">
								<div class="dropdown custom-dropdown">
									<button type="button" class="btn btn-sm btn-primary"
										data-toggle="dropdown">
										<i class="ti-search m-r-5"></i> 3 AM <i
											class="fa fa-angle-down m-l-5"></i>
									</button>
									<div class="dropdown-menu dropdown-menu-right">
										<a class="dropdown-item" href="#">6 AM</a> <a
											class="dropdown-item" href="#">9 AM</a> <a
							...
							<div class="col">
								<div class="dropdown custom-dropdown">
									<button type="button" class="btn btn-sm btn-primary"
										data-toggle="dropdown">
										<i class="ti-calendar m-r-5"></i> March 20, 2018 &nbsp; To
										&nbsp;April 20, 2018 <i class="fa fa-angle-down m-l-5"></i>
									</button>
									<div class="dropdown-menu dropdown-menu-right">
										<a class="dropdown-item" href="#">May 20, 2018 &nbsp; To
											&nbsp; June 20, 2018</a> <a class="dropdown-item" href="#">July
											20, 2018 &nbsp; To &nbsp; August 20, 2018</a>
									</div>
								</div>
							</div>
							<div class="col">
