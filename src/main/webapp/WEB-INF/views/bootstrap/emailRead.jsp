						...
						<div class="email-right-box">
							<div class="toolbar" role="toolbar">
								...
								<div class="btn-group m-b-20">
									...
									<div class="dropdown-menu">
										<a class="dropdown-item" href="javascript: void(0);">Mark
							...
							<div class="read-content">
								...
								<div class="media mb-4 mt-1">
									<div class="media-body">
										...
										<h4 class="m-0 text-primary">A collection of textile
											samples lay spread</h4>
										<small class="text-muted">To:Me,invernessmckenzie@example.com</small>
									</div>
								</div>
								<h5 class="m-b-15">Hi,Ingredia,</h5>
								<p>
									<strong>Ingredia Nutrisha,</strong> A collection of textile
								...
								<div class="form-group p-t-15">
									<textarea class="w-100 p-20 l-border-1" name="" id="" cols="30"
										rows="5"
