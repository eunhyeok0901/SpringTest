				...
				<div class="card">
					<div class="card-body">
						...
						<div class="progress mb-3" style="height: 11px">
							<div class="progress-bar bg-info" style="width: 40%;"progressbar">
								<span class="sr-only">60% Complete</span>
							</div>
						</div>
					...
					<div class="card-body">
						...
						<div class="progress progress-vertical">
							<div class="progress-bar bg-danger"
								style="width: 7px; height: 60%;" role="progressbar">
								<span class="sr-only">60% Complete</span>
							</div>
						</div>
						<div class="progress progress-vertical">
							<div class="progress-bar bg-info"
								style="width: 7px; height: 80%;" role="progressbar">
								<span class="sr-only">60% Complete</span>
							</div>
						</div>
						<div class="progress progress-vertical">
						...
						<div class="progress progress-vertical">
							<div class="progress-bar bg-primary"
								style="width: 7px; height: 40%;" role="progressbar">
								<span class="sr-only">60% Complete</span>
							</div>
						</div>
						<div class="progress progress-vertical">
							<div class="progress-bar bg-warning"
								style="width: 7px; height: 30%;" role="progressbar">
								<span class="sr-only">60% Complete</span>
							</div>
						</div>
					</div>
			...
			<div class="col-md-12">
				<div class="card">
					<div class="card-body">
						...
						<div class="progress progress-vertical">
							<div class="progress-bar bg-info"
								style="width: 9px; height: 80%;" role="progressbar">
								<span class="sr-only">60% Complete</span>
							</div>
						</div>
						<div class="progress progress-vertical">
							<div class="progress-bar bg-success"
								style="width: 11px; height: 60%;" role="progressbar">
								<span class="sr-only">60% Complete</span>
							</div>
						</div>
						<div class="progress progress-vertical">
							<div class="progress-bar bg-primary"
								style="width: 13px; height: 40%;" role="progressbar">
								<span class="sr-only">60% Complete</span>
							</div>
						</div>
						<div class="progress progress-vertical">
							<div class="progress-bar bg-warning"
								style="width: 16px; height: 30%;" role="progressbar">
								<span class="sr-only">60% Complete</span>
							</div>
						</div>
					</div>
			...
			<div class="col-md-12">
				<div class="card">
					<div class="card-body">
						...
						<div class="progress mb-3" style="height: 9px;">
							<div class="progress-bar bg-info wow  progress-"
								style="width: 40%;" role="progressbar">
								<span class="sr-only">60% Complete</span>
							</div>
						</div>
						...
						<div class="progress mb-3" style="height: 13px;">
							<div class="progress-bar bg-primary wow  progress-"
								style="width: 30%;" role="progressbar">
								<span class="sr-only">60% Complete</span>
							</div>
						</div>
						<div class="progress mb-3" style="height: 15px;">
							<div class="progress-bar bg-warning wow  progress-"
								style="width: 80%;" role="progressbar">
								<span class="sr-only">60% Complete</span>
							</div>
						</div>
						<div class="progress mb-3" style="height: 17px;">
							<div class="progress-bar bg-inverse wow  progress-"
								style="width: 40%;" role="progressbar">
								<span class="sr-only">60% Complete</span>
							</div>
						</div>
			...
			<div class="col-md-12">
				<div class="card">
					<div class="card-body">
						...
						<h5 class="mt-3">
							Photoshop <span class="float-right">85%</span>
						</h5>
						<div class="progress" style="height: 9px">
							<div class="progress-bar bg-danger wow  progress-"
								style="width: 85%;" role="progressbar">
						...
						<h5 class="mt-3">
							Code editor <span class="float-right">90%</span>
						</h5>
						<div class="progress" style="height: 9px">
							<div class="progress-bar bg-info wow  progress-"
						...
						<h5 class="mt-3">
							Illustrator <span class="float-right">65%</span>
						</h5>
						<div class="progress" style="height: 9px">
							<div class="progress-bar bg-success wow  progress-"
