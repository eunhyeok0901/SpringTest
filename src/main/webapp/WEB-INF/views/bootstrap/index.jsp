		...
		<div class="row">
			<div class="col-lg-3 col-sm-6">
				<div class="card gradient-1">
					<div class="card-body">
						<h3 class="card-title text-white">판매된 제품</h3>
						<div class="d-inline-block">
							<h2 class="text-white">4565개</h2>
							<p class="text-white mb-0">2022년 12월 20일</p>
						</div>
			...
			<div class="col-lg-3 col-sm-6">
				<div class="card gradient-3">
					<div class="card-body">
						<h3 class="card-title text-white">신규 고객</h3>
						<div class="d-inline-block">
							<h2 class="text-white">4565명</h2>
							<p class="text-white mb-0">2022년 12월 20일</p>
						</div>
						<span class="float-right display-5 opacity-5"><i
			...
			<div class="col-lg-3 col-sm-6">
				<div class="card gradient-4">
					<div class="card-body">
						<h3 class="card-title text-white">고객 만족도</h3>
						<div class="d-inline-block">
					...
					<div class="col-12">
						<div class="card">
							<div class="card-body pb-0 d-flex justify-content-between">
								<div>
									<h4 class="mb-1">제품 세일</h4>
									<p>이달의 총 수입</p>
									<h3 class="m-0">9383만원</h3>
								</div>
								<div>
									<ul>
										...
										<li class="d-inline-block mr-3"><a class="text-dark"
											href="#">주</a></li>
										<li class="d-inline-block"><a class="text-dark" href="#">월</a></li>
									</ul>
								</div>
							</div>
		...
		<div class="row">
			...
			<div class="col-lg-3 col-md-6">
				<div class="card card-widget">
					<div class="card-body">
						<h5 class="text-muted">주문 개요</h5>
						<h2 class="mt-4">5680</h2>
						<span>총 수입</span>
						<div class="mt-4">
							<h4>30</h4>
							<h6>
								온라인 주문 <span class="pull-right">30%</span>
							</h6>
						...
						<div class="mt-4">
							...
							<h6 class="m-t-10 text-muted">
								오프라인 주문 <span class="pull-right">50%</span>
							</h6>
							<div class="progress mb-3" style="height: 7px">
						...
						<div class="mt-4">
							<h4>20</h4>
							<h6 class="m-t-10 text-muted">
								배달 후 운송료 지불 <span class="pull-right">20%</span>
							</h6>
							<div class="progress mb-3" style="height: 7px">
			...
			<div class="col-lg-3 col-md-6">
				<div class="card">
					<div class="card-body px-0">
						<h4 class="card-title px-4 mb-3">할일</h4>
						<div class="todo-list">
							<div class="tdl-holder">
								<div class="tdl-content">
									<ul id="todo_list">
										<li><label><input type="checkbox"><i></i><span>일어나기</span><a href='#' class="ti-trash"></a></label></li>
										<li><label><input type="checkbox" checked><i></i><span>세수하기</span><a href='#' class="ti-trash"></a></label></li>
										<li><label><input type="checkbox"><i></i><span>과제하기</span><a href='#' class="ti-trash"></a></label></li>
										<li><label><input type="checkbox" checked><i></i><span>집에 가기</span><a href='#' class="ti-trash"></a></label></li>
									</ul>
								</div>
								<div class="px-4">
									<input type="text" class="tdl-new form-control"
										placeholder="새 항목을 작성하고 enter를 누르세요.">
								</div>
							</div>
						</div>
					</div>
