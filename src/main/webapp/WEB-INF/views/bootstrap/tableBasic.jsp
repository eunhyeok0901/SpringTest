							...
							<table class="table table-bordered verticle-middle">
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<div class="progress" style="height: 10px">
												<div class="progress-bar gradient-4" style="width: 70%;"
													role="progressbar">
													<span class="sr-only">70% Complete</span>
												</div>
											</div>
									...
									<tr>
										...
										<td>
											<div class="progress" style="height: 10px">
												<div class="progress-bar gradient-9" style="width: 70%;"
													role="progressbar">
													<span class="sr-only">70% Complete</span>
												</div>
											</div>
							...
							<table class="table header-border">
								...
								<tbody>
									<tr>
										...
										<td>$45.00</td>
										<td><span class="label gradient-1 rounded">Paid</span></td>
										<td>EN</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td>$77.99</td>
										<td><span class="label gradient-2 rounded">Paid</span></td>
										<td>FR</td>
									</tr>
								</tbody>
							</table>
