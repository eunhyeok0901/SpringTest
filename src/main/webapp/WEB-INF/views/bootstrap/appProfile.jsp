				...
				<div class="card">
					<div class="card-body">
						<div class="media align-items-center mb-4">
							<img class="mr-3" src="${pageContext.request.contextPath }/resources/bootstrap/images/avatar/11.png" width="80"
								height="80" alt="">
				...
				<div class="card">
					<div class="card-body">
						<div class="media media-reply">
							<img class="mr-3 circle-rounded" src="${pageContext.request.contextPath }/resources/bootstrap/images/avatar/2.jpg"
							...
							<div class="media-body">
								...
								<ul>
									<li class="d-inline-block"><img class="rounded" width="60"
										height="60" src="${pageContext.request.contextPath }/resources/bootstrap/images/blog/2.jpg" alt=""></li>
									<li class="d-inline-block"><img class="rounded" width="60"
										height="60" src="${pageContext.request.contextPath }/resources/bootstrap/images/blog/3.jpg" alt=""></li>
									<li class="d-inline-block"><img class="rounded" width="60"
										height="60" src="${pageContext.request.contextPath }/resources/bootstrap/images/blog/4.jpg" alt=""></li>
									<li class="d-inline-block"><img class="rounded" width="60"
										height="60" src="${pageContext.request.contextPath }/resources/bootstrap/images/blog/1.jpg" alt=""></li>
								</ul>

								<div class="media mt-3">
									<img class="mr-3 circle-rounded circle-rounded"
										src="${pageContext.request.contextPath }/resources/bootstrap/images/avatar/4.jpg" width="50" height="50"
