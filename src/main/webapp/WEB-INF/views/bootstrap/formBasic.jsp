				...
				<div class="card">
					<div class="card-body">
						...
						<p class="text-muted m-b-15 f-s-12">
							...
							<code>.input-default, input-flat, .input-rounded</code>
							for Default input.
						</p>
							...
							<form>
								...
								<div class="form-group">
									<label>Mutiple select list (hold shift to select more
										than one):</label> <select multiple="multiple" class="form-control"
										id="sel2">
										<option>1</option>
										<option>2</option>
										<option>3</option>
				...
				<div class="card">
					<div class="card-body">
						...
						<p class="text-muted">
							...
							<code>.form-control-lg and .form-control-sm.</code>
						</p>
						<div class="basic-form">
							<form>
								<div class="form-group">
								...
								<div class="form-group row">
									...
									<div class="col-sm-9">
										<input type="text" readonly="readonly"
											class="form-control-plaintext" value="email@example.com">
									</div>
								</div>
								<div class="form-group row">
					...
					<div class="card-body">
						...
						<div class="basic-form">
							<form class="form-inline">
								...
								<button type="submit" class="btn btn-dark mb-2">Confirm
									identity</button>
							</form>
						</div>
					</div>
										...
										<div class="col-sm-10">
											<div class="form-check">
												<input class="form-check-input" type="radio"
													name="gridRadios" value="option1" checked="checked">
											...
											<div class="form-check disabled">
												<input class="form-check-input" type="radio"
													name="gridRadios" value="option3" disabled="disabled">
			...
			<div class="col-lg-12">
				<div class="card">
					<div class="card-body">
						...
						<p class="text-muted">
							Be sure to use
							<code>.col-form-label-sm .col-form-label-lg</code>
									...
									<div class="col-auto my-1">
										<div class="custom-control custom-checkbox mr-sm-2">
											<input type="checkbox" class="custom-control-input"
												...
												class="custom-control-label">Remember my preference</label>
										</div>
									</div>
								</div>
							</form>
								...
								<fieldset disabled="disabled">
									...
									<div class="form-check">
										<input class="form-check-input" type="checkbox"
											disabled="disabled"> <label class="form-check-label">Can't
											check this</label>
									</div>
